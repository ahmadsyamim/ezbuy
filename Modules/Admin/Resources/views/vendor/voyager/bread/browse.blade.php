...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}" class="btn btn-success btn-add-new btn-loading">
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="ui compact unstackable table">
                                <thead>
                                    <tr>
