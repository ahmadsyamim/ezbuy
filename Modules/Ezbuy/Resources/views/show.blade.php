...
@endpush
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				<h1>PURCHASE</h1>
				<span>"Buy Now or Regret Later"</span>
				<ol class="breadcrumb">
					...
					<div class="container clearfix">
						...
						<div class="row col-mb-50">
							<div class="col-md-6 d-none d-md-flex align-self-end">
								<img src="{{ url('/') }}/images/services/4.jpg" alt="Image" class="mb-0">
							</div>

							@livewire('product-add', ['data' => $data])
				...
				<div class="container clearfix">
					...
					@else 
						<ul class="tab-nav clearfix">
							<li><a href="#tabs-9">You might Like</a></li>
