                                ...
                                @csrf                                   
									...
									<div class="col-12 form-group">
										<div class="row">
											...
											<div class="col-sm-10">
												<input type="text" name="phone_number" id="fitness-form-phone" class="form-control required" value="{{ old('phone_number') }}" placeholder="Your Contact Number">
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="btn-group d-flex" role="group">
													...
													<label style="margin-bottom:unset;" for="fitness-form-male" class="btn btn-outline-dark font-body ls0 nott">Male</label>

													<input type="radio" class="btn-check required" name="gender" id="fitness-form-female" value="female">
													<label style="margin-bottom:unset;" for="fitness-form-female" class="btn btn-outline-dark font-body ls0 nott">Female</label>
												</div>
									...
									<div class="col-12 form-group">
										<div class="row">
											...
											<div class="col-sm-5">
												<div class="input-group">
                                                    <input type="text" name="postcode" id="fitness-form-phone" class="form-control required" value="{{ old('postcode') }}" placeholder="Postcode">
									...
									<div class="col-12 form-group">
										<div class="row">
											...
											<div class="col-sm-10">
                                                <textarea name="address" id="event-registration-bio" class="form-control required" cols="30" rows="5">{{ old('address') }}</textarea>
